...
class Application:
    ...
    def __init__(self, output_path = "./"):
        ...
        btnPlay = tk.Button(self.root,   text="PLAY", command=self.playAudio)
        btnStop = tk.Button(self.root,  text="STOP", command=self.stopAudio)
        btnPause = tk.Button(self.root,  text="PAUSE", command=self.pauseAudio)
        btnUnPause = tk.Button(self.root,  text="UNPAUSE", command=self.unpauseAudio)
        ...
        btnStop.pack(side = "left" , padx=10, pady=10)
        btnPause.pack(side = "left" , padx=10, pady=10)
        btnUnPause.pack(side = "left" , padx=10, pady=10)
